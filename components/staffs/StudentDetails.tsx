...
// Updated mock function to include certificates
const fetchStudentData = (id: string) => {
  ...
  const certificates: Certificate[] = [
    {
      ...
      description: "Awarded for excellence in React development.",
      image: "https://via.placeholder.com/150",
      date: "2025-02-01",
    },
    {
      title: "Data Structures Pro",
      description: "Recognized for outstanding performance in Data Structures.",
      image: "https://via.placeholder.com/150",
      date: "2025-03-01",
    },
    {
      title: "Algorithm Guru",
      description: "Excellence in algorithm problem solving.",
      image: "https://via.placeholder.com/150",
      date: "2025-04-15",
    },
  ];
  ...
  return {
    ...
    certificates, // added certificates array
  };
};
...
export function StudentDetails({ id }: { id: string }) {
  ...
  const problemData = [
    {
      name: "Easy",
      value: student.codingStats.easy.solved,
      total: student.codingStats.easy.total,
    },
    {
      name: "Medium",
      value: student.codingStats.medium.solved,
      total: student.codingStats.medium.total,
    },
    {
      name: "Hard",
      value: student.codingStats.hard.solved,
      total: student.codingStats.hard.total,
    },
  ];
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex justify-between text-sm">
              <span>
                XP: {currentXP}/{student.nextLevelXP}
              </span>
              <span>
                {Math.floor((currentXP / student.nextLevelXP) * 100)}%
              </span>
            </div>
            <Progress
              value={(currentXP / student.nextLevelXP) * 100}
                    ...
                    <div className="space-y-6">
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span className="text-sm text-gray-500">
                            {
                              student.codingStats.easy.solved
                            }/{student.codingStats.easy.total}
                          </span>
                        </div>
                        <Progress
                          value={
                      ...
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span className="text-sm text-gray-500">
                            {
                              student.codingStats.medium.solved
                            }/{student.codingStats.medium.total}
                          </span>
                        </div>
                        <Progress
                          value={
                      ...
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span className="text-sm text-gray-500">
                            {
                              student.codingStats.hard.solved
                            }/{student.codingStats.hard.total}
                          </span>
                        </div>
                        <Progress
                          value={
            ...
            <TabsContent value="hackathons">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Participated in {student.hackathonsParticipated} hackathons and won{" "}
                ...
                <CardContent>
                  <Table>
                    ...
                    <TableBody>
                      {student.hackathonHistory.map((hackathon: any, index: number) => (
                        <TableRow key={index}>
                  ...
                  <div className="mt-8">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600 ml-7 mb-4">
                        Excellent in Web Development. Consistently scores above 90%
                      ...
                      <p className="text-sm text-gray-600 ml-7">
                        Could improve algorithm optimization skills. Recommended to
                        practice more medium and hard-level algorithm problems.
                      </p>
                    </div>
                  </div>
                </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {student.certificates.map((cert: Certificate, index: number) => (
              <div
                key={index}
