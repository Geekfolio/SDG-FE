            ...
            <CardContent>
              <div className="space-y-4">
                {student.badges.map((badge: StudentBadge, index: number) => (
                  ...
                  >
                    <div
                      className={`p-2 rounded-full ${getBadgeColor(badge.level)}`}
                    >
                      {badge.icon}
                    </div>
            ...
            <TabsContent value="hackathons">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Participated in {student.hackathonsParticipated} hackathons
                    and won {student.hackathonsWon}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Table>
                  ...
                  <div className="mt-8">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600 ml-7 mb-4">
                        Excellent in Web Development. Consistently scores above
                        90% in practical assignments.
                      </p>
                      ...
                      <p className="text-sm text-gray-600 ml-7">
                        Could improve algorithm optimization skills. Recommended
                        to practice more medium and hard-level algorithm
                        problems.
                      </p>
                    </div>
                  </div>
