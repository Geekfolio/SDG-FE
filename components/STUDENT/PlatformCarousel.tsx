          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4 w-full mt-4 text-sm">
              <div className="flex flex-col items-center p-2 rounded-md bg-green-50 dark:bg-green-900/20">
                ...
                <span className="text-gray-700 dark:text-gray-300">{platform.stats.easy.solved}/{platform.stats.easy.total}</span>
              </div>
              <div className="flex flex-col items-center p-2 rounded-md bg-yellow-50 dark:bg-yellow-900/20">
                ...
                <span className="text-gray-700 dark:text-gray-300">{platform.stats.medium.solved}/{platform.stats.medium.total}</span>
              </div>
              <div className="flex flex-col items-center p-2 rounded-md bg-red-50 dark:bg-red-900/20">
                ...
                <span className="text-gray-700 dark:text-gray-300">{platform.stats.hard.solved}/{platform.stats.hard.total}</span>
              </div>
            </div>
          </div>
        ) : (
