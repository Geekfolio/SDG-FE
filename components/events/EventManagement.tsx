...
import { PlusCircle, Calendar, Users, Trophy, Clock, ChevronDown, Search, X, Filter, Mail } from "lucide-react";
    ...
    fetch("http://localhost:8000/events")
      ...
      .then((data) => {
        const transformed = data.map((event: any, index: number) => ({
          ...
          status: event.status.toLowerCase() === "in progress" ? "In Progress" : event.status,
      ...
      {selectedEventId && selectedEvent ? (
        <div className="border rounded-lg p-6 bg-card shadow-sm">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <div className="flex items-center gap-3">
              <Button variant="ghost" onClick={handleBackToEvents} className="group hover:bg-accent">
              ...
              <span className={`ml-2 ${statusColors[selectedEvent.status as keyof typeof statusColors]} rounded-md px-2 py-1 text-sm font-medium`}>
            ...
            {userRole === USER_ROLE.STAFF && (
              <div className="flex items-center gap-2">
                ...
                <Button variant="default" className="gap-1 bg-gradient-to-br from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700" >
        ...
        <>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            ...
            <div className="flex items-center gap-2">
              <EventCreationFormModal isCreatingEvent={isCreatingEvent} setIsCreatingEvent={setIsCreatingEvent} />
